...
const Result: React.FC = () => {
  ...
  const profile1 = locationState?.profile1 || {
    id: 0,
    name: '사용자1',
    mbti: 'MBTI',
    heartRate: 75,
  ...
  const profile2 = locationState?.profile2 || {
    id: 0,
    name: '사용자2',
    mbti: 'MBTI',
    heartRate: 78,
    ...
    <_.Container>
      ...
      <_.ContentWrapper>
        ...
        <_.ProfileSection>
          <_.ProfileBox>
            <_.ProfileImageWrapper>
              <_.ProfileImage
                src={profile1.imageUrl || NormalPofileImg}
                alt={profile1.name}
              />
            </_.ProfileImageWrapper>
            <_.ProfileInfo>
          ...
          <_.ProfileBox>
            <_.ProfileImageWrapper>
              <_.ProfileImage
                src={profile2.imageUrl || NormalPofileImg}
                alt={profile1.name}
              />
            </_.ProfileImageWrapper>
            <_.ProfileInfo>
        ...
        <_.AnalysisSection>
          ...
          <_.AnalysisBox>
            <_.AnalysisText>
              {profile1.name} 님은 {profile2.name} 님과{' '}
            ...
            <_.AnalysisText>
              {profile1.name} 님과 {profile2.name} 님은{' '}
        ...
        <_.OtherCompatibilitySection>
          ...
          <_.OtherCompatibilityText>
            {profile1.name} 님은 <_.Highlight>이원희</_.Highlight>님과 10점으로
            가장 사이가 나쁜 관계입니다. 체온이 비슷했으며 심박도에서 큰 차이가
            나타났습니다.
            <br />
            {profile1.name} 님은 <_.Highlight>이로하</_.Highlight>님과 88 점으로
            좋은 관계입니다! 이로하 님과 체온이 가장 비슷했으며 MBTI에서 차이가
            나타났습니다.
            <br />
            {profile1.name} 님은 <_.Highlight>빌려온 고양이</_.Highlight> 님과
